...
<div class="activities view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Activity Comment') ?></th>
            <td><?= h($activity->activity_comment) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Activity Status') ?></th>
            <td><?= h($activity->activity_status) ?></td>
        </tr>
        <tr>
    ...
    <div class="row">
        <h4><?= __('Activity On') ?></h4>
        <?= $this->Text->autoParagraph(h($activity->activity_on)); ?>
    </div>
</div>
